...
Esses mapas recebem dados de milhares ou milhões de **sensores, firewalls, antivírus e sistemas de monitoramento** espalhados pela internet.
Quando um ataque é detectado, a informação é enviada para os servidores da empresa de segurança e exibida no mapa.
...
* **Check Point Software Technologies** – Threat Map
...
* [https://attackmap.sonicwall.com/live-attack-map/](https://attackmap.sonicwall.com/live-attack-map/)
* **Bitdefender** – Threat Map
* [https://threatmap.bitdefender.com/](https://threatmap.bitdefender.com/)
* **NETSCOUT** – Horizon Threat Intelligence
...
**Resumo:**
Mapas de ataques cibernéticos em tempo real são **dashboards visuais que mostram atividades de ameaças na internet enquanto acontecem**, baseados nos dados coletados por empresas de cibersegurança.
